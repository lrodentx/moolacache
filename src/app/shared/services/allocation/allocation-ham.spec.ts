...
import { AllocationHAM } from './allocation-ham';

describe('AllocationHAM', () => {
  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [
        { provide: AllocationHAM, useFactory: () => new AllocationHAM(0, []) },
        { provide: AllocationServiceFactory, useClass: AllocationServiceFactory, deps: [ AllocationHAM ] },
      ]
    });
  });
  ...
  it('should be created', inject([AllocationServiceFactory], (factory: AllocationServiceFactory) => {
    ...
    expect(allocationService.config).toEqual(jasmine.any(AllocationHAM));
  ...
  it('allocate 1.00', inject([AllocationServiceFactory], (factory: AllocationServiceFactory) => {
    ...
    const allocationService: AllocationService = factory.createServiceWithConfig(new AllocationHAM(1.00, allocations));
  ...
  it('allocate 1.33', () => {
    ...
    const allocationService: AllocationService = factory.createServiceWithConfig(new AllocationHAM(1.33, allocations));
  ...
  it('allocate .07', () => {
    ...
    const factory = TestBed.get(AllocationServiceFactory);
    const allocationService: AllocationService = factory.createServiceWithConfig(new AllocationHAM(.07, allocations));
  ...
  it('allocate .27', () => {
    ...
    const factory = TestBed.get(AllocationServiceFactory);
    const allocationService: AllocationService = factory.createServiceWithConfig(new AllocationHAM(.27, allocations));
    ...
    expect(val1.amount).toBe(.04);
    expect(val2.amount).toBe(.04);
    expect(val3.amount).toBe(.07);
  ...
  it('allocate 1234.56', () => {
    ...
    const factory = TestBed.get(AllocationServiceFactory);
    const allocationService: AllocationService = factory.createServiceWithConfig(new AllocationHAM(1234.56, allocations));
